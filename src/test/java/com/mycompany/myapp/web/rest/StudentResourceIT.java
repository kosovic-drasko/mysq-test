...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().ime(DEFAULT_IME);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().ime(UPDATED_IME);
        return student;
    }
    ...
    void createStudent() throws Exception {
        ...
        assertThat(testStudent.getIme()).isEqualTo(DEFAULT_IME);
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.ime(UPDATED_IME);
        ...
        Student testStudent = studentList.get(studentList.size() - 1);
        assertThat(testStudent.getIme()).isEqualTo(UPDATED_IME);
    }
    ...
    void fullUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.ime(UPDATED_IME);
